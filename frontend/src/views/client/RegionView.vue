    ...
    <div class="view-container">
        <nav aria-label="breadcrumb">
            <ol class="breadcrumb">
                ...
                <li v-if="regionName" class="breadcrumb-item">{{ regionName }}</li>
            </ol>
        </nav>
            ...
            <div class="left-side-bar-container">
                <div class="filter-container">
                    ...
                    <div class="checkBoxes" style="width: 100%;padding: 0.5rem;">
                        ...
                        <div class="form-check">
                            <input v-model="discountFilter" class="form-check-input" type="checkbox"
                                id="discountFilter">
...
const discountFilter = ref(false)
const tourType = ref("")
const minDay = ref(1)
const maxDay = ref(20)
...
function fetchName() {
    baseUrl.get("/client/region/name/" + route.params.slug).then((response) => {
...
function fetchTour() {
    tourList.value = null;
    baseUrl.get("/client/region/tour/" + route.params.slug + "/" + orderBy.value + "/" + sortOrder.value + "/" + pageNumber.value,
        {
            params: {
