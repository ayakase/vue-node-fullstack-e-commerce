...
<template>
  <div class="mobile-nav-container">
    <div style="position: relative;" class="mobile-nav">
      <div class="logo-container" @click="router.push('/')"><img src="./assets/logo.png" alt="" class="mobile-logo">
      </div>
  ...
  <div class="header-container" v-if="!route.meta.hideNavbar">
    <div v-if="loginStore.login">
      <div><button @click="logout" class=" btn btn-danger active admin-button" aria-current="page" href="#">Logout
        ...
        <RouterLink class=" btn btn-success active logout-button" to="/admin/thong-ke" aria-current="page" href="#">
          Admin Panel
        </RouterLink>
      </div>
    </div>
    ...
    <nav class="navbar navbar-expand-lg custom-bg">
      <div class="container-fluid">
              ...
              <ul class="nav-menu" style="border: 0;padding: 0;">
                <li class="dropdown">
                  ...
                  <ul class="drop-one" style="margin: 0;padding: 0;">
                    ...
                    <RouterLink class="nav-link active" to="/dia-diem/du-lich-trung-quoc" aria-current="page" href="#">
                      Du
                      lịch
                      Trung
                      Quốc
                    ...
                    <li>
                      <RouterLink class="nav-link active" to="/danh-muc/du-lich-trong-nuoc" aria-current="page"
                        href="#">
                        Du lịch
                        trong
                        nước
        ...
        location.name }}</p>
                    ...
                    <RouterLink class="nav-link active" to="/cam-nang" aria-current="page" href="#">Bài viết
                    </RouterLink>
                  </ul>
                </li>
              </ul>
