<template>
    <div class="header-container" v-if="!route.meta.hideNavbar">
            ...
            <div class="container-fluid">
                ...
                <div class="collapse navbar-collapse" id="navbarSupportedContent">
                    <ul class="navbar-nav me-auto ">
                        ...
                        <li>
                            <RouterLink class="nav-link active" to="/dia-diem/du-lich-trung-quoc" aria-current="page"
                                href="#">
                                Du
                                lịch
                                Trung
                        ...
                        <li>
                            <RouterLink class="nav-link active domestic-category" to="/danh-muc/du-lich-trong-nuoc"
        ...
        location.name }}</p>
                        ...
                        <li>
                            <RouterLink class="nav-link " to="/danh-muc/du-lich-quoc-te" aria-current="page" href="#">
                                Du lịch quốc tế
        ...
        location.name }}</p>
                        ...
                        <li style="justify-self: flex-end;">
                            <form class="d-flex search-container" style="margin-top:.3rem;padding: 0;">
                                <input
                                    @keydown.enter.prevent="router.push({ path: '/tim-kiem/', query: { keyword: searchText } })"
                                    v-model="searchText" class="form-control me-2 search-box" type="search"
                        ...
                        <li><button style="margin-top:.3rem;" class=" btn btn-outline-success"
                                @click="router.push({ path: '/tim-kiem/', query: { keyword: searchText } })"><i
                                    class="fas fa-search"></i></button>
                        </li>
                    </ul>
